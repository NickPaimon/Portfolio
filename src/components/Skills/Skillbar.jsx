...
const SkillBar = ({ skill, level, startAnimation, id }) => {
  ...
  return (
    <div
      className={`bg-blend-color-burn border-2 border-gray-500 hover:border-gray-400 w-[280px]  h-[220px]   bg-gradient-to-r from-gray-800 to-gray-900 shadow-2xl flex flex-col justify-center items-center space-y-4 rounded-lg transition-all duration-200 ease-in-out transform m-4 ${
